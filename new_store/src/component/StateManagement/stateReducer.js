...
export const myShop = (state=initState, {type, payload}) => {
  switch (type) {
    
    case actionType.ADD_TO_CART:
      const item = state.store.find(el => el.id === payload.id)
    ...
    case actionType.ADJUST_CART_QTY:
      return{
        ...state,
    ...
    case actionType.LOAD_CART_ITEMS:
      return{
        ...state,
        currentItem: payload
      }
